...
import {
  compile
} from "./chunk-2IOS7C4O.js";
import "./chunk-7PPKGCT5.js";
import "./chunk-O5R2T3HQ.js";
import {
  __commonJS,
  __toESM
} from "./chunk-EZMDZOIB.js";
...
async function mdxPlugin(options) {
  let include = /\.mdx$/, filter = createFilter(include), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-7IJLGGAJ.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-ACVIXYFU.js")).default;
  return {
